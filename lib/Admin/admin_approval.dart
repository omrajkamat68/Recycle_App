                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.person, color: Colors.green, size: 28.0,),
                                    SizedBox(width: 10.0,),
                                    Text("Omraj Kamat", style: AppWidget.normaltextstyle(20.0),)
                                  ],
                                ),
                                Row(
                                  children: [
                                    Icon(Icons.location_on, color: Colors.green, size: 28.0,),
                                    SizedBox(width: 10.0,),
                                    Container(
                                      width: MediaQuery.of(context).size.width/3,
                                      child: Text("Near Main Market, delhi", style: AppWidget.normaltextstyle(20.0),))
                                  ],
                                ),
                                Row(
                                  children: [
                                    Icon(Icons.inventory, color: Colors.green, size: 28.0,),
                                    SizedBox(width: 10.0,),
                                    Container(
                                      width: MediaQuery.of(context).size.width/3,
                                      child: Text("3", style: AppWidget.normaltextstyle(20.0),))
                                  ],
                                ),
                                SizedBox(height: 5.0,),
                                Container(
